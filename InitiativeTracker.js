//"Initiative Tracker"
//Apparently re-sorting once the script starts will NOT restart the round counter! Handy!
//However, status effect durations are tracked by the round counter, not individual turns.
var Tracker = Tracker || {
	...
	if (!state.hasOwnProperty('InitiativeTracker')){
	    state.InitiativeTracker = {
					'highToLow':		true,
					'announceRounds':	false, //Setting this to false here hopefully turns this off by default?
					'announceTurns':	true,
	...
	sendChat("", "/desc Start of Round " + round + ". Exalts regain five motes."); //Hopefully this automatically reminds players to regain motes. Wonder if I could automate this?
    },
